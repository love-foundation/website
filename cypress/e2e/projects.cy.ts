describe('Projects Page Functionality', () => {
	...
	it.skip('filters the projects when using one of the filter options', () => {
	...
	it.skip('changes the filter when clicking another category', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
	...
	it.skip('removes the filter when clicking the same category again', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
		cy.get('[data-cy=projectFilter]').first().click();
		cy.get('[data-cy=projectItem]').should('have.length.lt', 7);
		cy.get('[data-cy=projectFilter]').first().click();
	...
	it.skip('filters the projects for water projects', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
	...
	it.skip('filters the projects for community projects', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
		cy.get('[data-cy=projectFilter]').contains('Community Spirit').click();
		cy.get('[data-cy=projectItem]').should('have.length', 2);
		cy.get('[data-cy=projectPillar]').should('have.class', 'community');
	...
	it.skip('filters the projects for sustainability projects', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
	...
	it.skip('filters the projects for joy projects', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
	...
	it.skip('filters the projects for love projects', () => {
		cy.get('[data-cy=projectItem]').should('have.length', 7);
